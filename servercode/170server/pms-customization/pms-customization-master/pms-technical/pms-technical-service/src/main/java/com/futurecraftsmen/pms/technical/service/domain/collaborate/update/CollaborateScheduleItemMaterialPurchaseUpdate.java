...
/**
 * @author chengxinyu
 * @description 销售方协作安排数据表, 物料计划采购已安排量
 * @organization futurecraftsmen
 * @date 2025-07-03 15:27
 */
@Data
@TableName(autoResultMap = true, value = "${dynamicTableNameProxy.collaborateScheduleItem}")
public class CollaborateScheduleItemMaterialPurchaseUpdate implements Serializable, MyBatisMark {
	...
	/**
	 * @description 物料计划采购已安排量：初始是 0 , 后续会修改
	 */
	@TableField(value = "material_purchase_quantity")
	@JsonSerialize(using = BigDecimalAutoStripTrailingZerosSerializer.class)
	private BigDecimal materialPurchaseQuantity;
