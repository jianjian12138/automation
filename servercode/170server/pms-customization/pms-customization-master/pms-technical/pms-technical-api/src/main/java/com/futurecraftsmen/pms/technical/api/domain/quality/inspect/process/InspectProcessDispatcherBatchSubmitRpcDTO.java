package com.futurecraftsmen.pms.technical.api.domain.quality.inspect.process;
...
public class InspectProcessDispatcherBatchSubmitRpcDTO extends AbstractRpcDTO {
     ...
     * @description
     */
    List<InspectProcessDispatcherOperatorRpcDTO> operatorList;
}
