...
public class ComponentWorkYStandardModel extends StationaryExcelModel {
	 ...
	 * 工艺路线/路线号
	 */
	@ExcelProperty("工艺路线/路线号")
	private String processRouteData;
	...
	@ExcelMultiListAop
	private List<WorkYStandardModel> materialModels;

	@Override
	public String getImportContent() {
		return "导入校验 部件-有工艺路线";
	}
